...
def check(chain, token, criteria):
  min_price, max_price, min_liquidity, max_liquidity, min_market_capital, max_market_capital = (
    criteria['min_price'],
    criteria['max_price'],
    criteria['min_liquidity'],
    criteria['max_liquidity'],
    criteria['min_market_capital'],
    criteria['max_market_capital']
  )
  ...
  if min_liquidity and liquidity < min_liquidity:
    return False
  if max_liquidity and liquidity > max_liquidity:
    return False
